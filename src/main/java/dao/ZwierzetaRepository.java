...
public class ZwierzetaRepository extends RepositoryBase<Zwierze> implements IRepositoryZwierze {
    ...
    protected String insertSql() {
        return "insert into "
                + tableName()
                + " (nazwa, tempo_jedzenia, poziom_najedzenia) values"
                + "(?,?,?)";
    }
    ...
    protected String updateSql() {
        return "update "
                + tableName()
                + " set (nazwa, tempo_jedzenia, poziom_najedzenia) ="
                + "(?,?,?)"
                + "where "
                + "id = ?";
    }
    ...
    protected void setUpdate(Zwierze entity) throws SQLException {
        ...
        update.setInt(3, entity.getPoziomNajedzenia());
    ...
    protected void setInsert(Zwierze entity) throws SQLException {
        ...
        insert.setInt(3, entity.getPoziomNajedzenia());
    }
