 ...
 * @author TKK
 */
public class ZwierzeDoTypJedzeniaRepository extends RepositoryBase<ZwierzeDoTypJedzenia> {

    public static final String TABLE_NAME = "zwierze_do_typ_jedzenia";
    ...
    protected String createTableSql() {
        return "create table "
                + tableName()
                + " id int generated by default as identity primary key, id_zwirze int, id_typ_jedzenia int)";
    }
